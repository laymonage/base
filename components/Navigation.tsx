...
const Navigation = () => {
  ...
  return (
    <nav role="navigation" className="max-w-3xl mx-auto">
      <div
        className={cn(
          'fixed bottom-0 z-20 flex flex-col-reverse w-full max-w-3xl py-3 transition-transform duration-500 transform bg-white sm:flex-row sm:justify-between sm:items-center dark:bg-gray-800 dark:text-blue-200 ease sm:top-0 sm:bottom-auto',
