    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <footer>
                    This XML Sitemap Stylesheet is based on <a href="https://github.com/pedroborges/xml-sitemap-stylesheet" >xml-sitemap-stylesheet</a> created by Pedro Borges, licensed under the <a href="https://raw.githubusercontent.com/pedroborges/xml-sitemap-stylesheet/refs/heads/master/LICENSE">MIT License</a>.
                </footer>
            </body>
        </html>
    </xsl:template>
